    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-20 lg:py-28">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-gold-400 font-semibold text-sm uppercase tracking-widest">Contact Us</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-8">
              ...
              <div className="card p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-gold-100 rounded-xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+19728244035" className="text-gray-500 text-sm hover:text-gold-600">+1 (972) 824-4035</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-gold-100 rounded-xl flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">Email</p>
                      <a href="mailto:momargroup@proton.me" className="text-gray-500 text-sm hover:text-gold-600">momargroup@proton.me</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-gold-100 rounded-xl flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
                    <div>
              ...
              <ScrollReveal>
              <div className="card p-8 bg-gold-600 text-white border-0">
                <h3 className="text-lg font-bold mb-3">Need a Quote?</h3>
                <p className="text-gold-100 text-sm mb-5">Get a free estimate for your cleaning service today.</p>
                <a href="/booking" className="inline-flex items-center gap-2 bg-white text-gold-700 font-semibold py-2.5 px-6 rounded-lg hover:bg-gray-100 transition-all text-sm">
                  Get Free Quote
